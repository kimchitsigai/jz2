...
def create_training_environment(
    ...
    print("Created ChannelAssembler in crete_training_environment()")
    if is_server:
    ...
    if not is_server:
      ...
      print("Opponent : Created ChannelAssembler in crete_training_environment()")
    ...
    if not is_server:
      ...
      for i in range(simulation_params.num_game):
          ...
          games.append(game)
    print("create_training_environment() end")
...
def run_training(
    ...
    print("call to save() de : ", str(model_path))
    print("type(model) apres create_model().to(): ", type(model))
    ...
    print("before update_model...")
    print("type(model) avant update_model(): ", type(model))
    assembler.update_model(model.state_dict())
    print("after update_model...")
