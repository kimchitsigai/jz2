...
script::Module ScriptModuleDeserializer::deserialize(
  ...
  std::cout << "ScriptModuleDeserializer::deserialize() dans import.cpp start \n";
  ...
  std::cout << "ScriptModuleDeserializer::GetDescriptor() : " <<  model_def.GetDescriptor()->full_name() << " dans import.cpp \n";
  ...
  if (!convert_result.ok()) {
    std::cout << "ScriptModuleDeserializer::convert_result() KO dans import.cpp \n";
    std::stringstream ss;
    ss << convert_result;
    AT_ERROR(ss.str());
  }
  ...
  std::cout << "ScriptModuleDeserializer::deserialize() dans import.cpp end \n";
...
script::Module ScriptModuleDeserializer::convertModule(
  ...
  std::cout << "convertModule() dans import.cpp start, module_def.name = " << module_def.name() << "\n";

  const auto atoms = c10::QualifiedName(module_def.name()).atoms();
  std::cout << "convertModule() dans import.cpp atoms.size = " << atoms.size() << "\n";
  ...
  std::cout << "convertModule() dans import.cpp submodules_size = " << module_def.submodules_size() << "\n";
  ...
  std::cout << "convertModule() dans import.cpp parameters_size = " << module_def.parameters_size() << "\n";
  ...
  std::cout << "convertModule() dans import.cpp end \n";
  return module;
}
